...
public class AppcacheManifestBuilder
{
	 ...
	 */
	public String getManifest(Aspect aspect, RequestMode requestMode) throws PropertiesException, ContentProcessingException, ConfigException, MalformedTokenException
	{
        ...
        if(version != null)
        {
            ...
            manifest += getManifestCacheFiles(aspect, requestMode);
	...
	private String getManifestCacheFiles(Aspect aspect, RequestMode requestMode) throws ContentProcessingException, ConfigException, MalformedTokenException, PropertiesException {
        ...
        {
            String pluginCacheFiles = getManifestCacheFilesForPlugin(aspect, requestMode, plugin, languages);
	...
	private String getManifestCacheFilesForPlugin(Aspect aspect, RequestMode requestMode, ContentPlugin plugin, Locale[] languages) throws ContentProcessingException, MalformedTokenException
	{
